  ...
  out float o5 : SV_Target5)
{
  ...
  r1.xyz = cb0[64].xyz + -v8.xyz;
  r0.z = dot(r1.xyz, r1.xyz);
  r1.xyz = -cb3[3].xyz + cb0[64].xyz;
  ...
  if (r0.y != 0) {
    ...
    r0.x = cmp(r0.x < 0);
    // Commenting out this line makes them visible at all times.
    // if (r0.x != 0) discard;
  }
  r0.x = max(r2.y, r2.z);
  r0.w = max(r2.x, r0.x);
