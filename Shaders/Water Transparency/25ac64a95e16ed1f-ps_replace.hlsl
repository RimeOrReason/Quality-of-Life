// Global water shader on lowest environment detail settings
  ...
  out float4 o0 : SV_Target0)
{
  ...
  r4.yzw = cb0[157].xyz + -cb0[151].xyz;
  r4.yzw = cb0[157].www * r4.yzw + cb0[151].xyz;
  r4.yzw = float3(-1,-1,-1) + r4.yzw;
  r4.yzw = r0.zzz * r4.yzw + float3(1,1,1);
  r6.xyz = r4.yzw * r7.xyz;
  r9.xyz = cb0[158].xyz + -cb0[152].xyz;
  r9.xyz = cb0[158].www * r9.xyz + cb0[152].xyz;
  ...
  r0.z = exp2(r0.z);
  r0.z = cb0[154].x * r0.z;
  r0.w = cb0[159].x * cb0[156].x;
  r2.w = cb0[156].y * -r5.x + 1;
  r2.w = max(0.0500000007, r2.w);
  r0.w = r2.w * r0.w;
  r2.w = saturate(cb0[156].z * r4.x);
  ...
  if (r1.y != 0) {
    ...
    r3.xyz = r0.yzw * cb0[160].xyz + -r0.yzw;
  ...
  r1.xyzw = cb0[180].xxxx ? r1.xyzw : r4.xyzw;
